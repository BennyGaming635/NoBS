const RICKROLLS =   [
    ...
    "youtube.com/shorts/SkIkZbbg_7g",
    ...
    "discord.com/vanityurl/dotcom/steakpants/flour/flower/index11.html",
    "https://lmg.gg/a6zOz"
  ];

  // This list is provided by https://github.com/larssieboy18/rickroll-list/

    export function isRickroll(url: string): boolean {
    const lower = url.toLowerCase();

    return RICKROLLS.some((rick) =>
        lower.includes(rick.toLowerCase())
    );
    }